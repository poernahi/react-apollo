(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('apollo-client'), require('graphql'), require('prop-types'), require('invariant')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'apollo-client', 'graphql', 'prop-types', 'invariant'], factory) :
	(factory((global['react-apollo'] = {}),global.React,global.ApolloClient,global.graphql,global.PropTypes,global.invariant));
}(this, (function (exports,React,ApolloClient,graphql,PropTypes,invariant) { 'use strict';
