(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('invariant'), require('lodash.pick'), require('object-assign'), require('hoist-non-react-statics'), require('redux'), require('react-dom/server'), require('graphql-tag')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'invariant', 'lodash.pick', 'object-assign', 'hoist-non-react-statics', 'redux', 'react-dom/server', 'graphql-tag'], factory) :
	(factory((global['react-apollo'] = {}),global.React,global.PropTypes,global.invariant,global.pick,global.assign,global.hoistNonReactStatics,global.redux,global.ReactDOM,global.graphqlTag));
}(this, (function (exports,React,PropTypes,invariant,pick,assign,hoistNonReactStatics,redux,ReactDOM,graphqlTag) { 'use strict';
...
function walkTree(element$$1, context, visitor) {
    ...
    if (typeof Component$$1 === 'function') {
        var props = assign({}, Component$$1.defaultProps, element$$1.props);
