(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('invariant'), require('lodash.pick'), require('object-assign'), require('hoist-non-react-statics'), require('redux'), require('apollo-client'), require('graphql-tag')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'invariant', 'lodash.pick', 'object-assign', 'hoist-non-react-statics', 'redux', 'apollo-client', 'graphql-tag'], factory) :
	(factory((global['react-apollo'] = {}),global.React,global.PropTypes,global.invariant,global.pick,global.assign,global.hoistNonReactStatics,global.redux,global.apolloClient,global.graphqlTag));
}(this, (function (exports,React,PropTypes,invariant,pick,assign,hoistNonReactStatics,redux,apolloClient,graphqlTag) { 'use strict';
